...
export const AuthLayout = ({image=null, children}) => {
    ...
    <div>
      <div className="h-full w-full max-w-lg mx-auto ">
        <div className="w-full h-full">
          <div className="h-32 sm:h-full flex-1 sm:px-6 hidden">
            <Image
              fill
              src={image}
              alt="login"
          ...
          <div className="flex-1 h-full p-6 lg:px-24">
            ...
            <div className="mt-6 ">
              ...
              <div>
                ...
                type="button"
                onClick={()=>{
                    router.push(pathname === "/auth/login" ? "/auth/register" : "/auth/login")
                }}
                >
                    {
                      pathname === "/auth/login" ? "S'inscrire" : "Se connecter"
                    }
                  
                </Button>{" "}
                <span className="text-slate-600 dark:text-slate-400 ">
                  ou {pathname === "/auth/login" ? "se connecter" : "s'inscrire"}
                  {" "}
